...
public class TicketServiceImpl implements TicketService {
    ...
    public boolean addMovies(MovieData movieData)
    {
    	...
    	boolean response= ticketRepository.addMoviesdata(movieData);
         LOGGER.debug("Reserved seats for customer {} with hold id {} and the confirmation code is {}"
                 , movieData.getMovieId(), movieData.getMovieName());
    	return response;
    ...
    {
    	List<MovieData> movieList= ticketRepository.showAllmoviesList();
